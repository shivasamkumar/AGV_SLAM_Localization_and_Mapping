...
class TwistConfigureNode(Node):
    def __init__(self):
        super().__init__("twist_configure")
        self.controller_sub = self.create_subscription(
            Twist,
            "/robot_car_v2_controller/cmd_vel_unstamped",
            self.controller_twist_callback,
            10
        )
        self.controller_pub = self.create_publisher(
            TwistStamped,
            "/robot_car_v2_controller/cmd_vel",
            10
        )
